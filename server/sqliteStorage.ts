...
export class SqliteStorage implements IStorage {
  ...
  private parseConfigRow(row: ConfigRow | undefined, watchedRepos: string[]): Config {
    ...
    return {
      ...
      autoHealCI: DEFAULT_CONFIG.autoHealCI,
      maxHealingAttemptsPerSession: DEFAULT_CONFIG.maxHealingAttemptsPerSession,
      maxHealingAttemptsPerFingerprint: DEFAULT_CONFIG.maxHealingAttemptsPerFingerprint,
      maxConcurrentHealingRuns: DEFAULT_CONFIG.maxConcurrentHealingRuns,
      healingCooldownMs: DEFAULT_CONFIG.healingCooldownMs,
      watchedRepos,
